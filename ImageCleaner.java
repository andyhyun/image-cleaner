...
public class ImageCleaner {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (fileList == null) {
            System.out.println("There must be image files in a 'pics' folder in this directory.");
            System.exit(0);
        }
        ...
        System.out.println("Enter just the number next to the algorithm that you want to choose:");
        System.out.println("\t1) Median\n\t2) Group Mode");
        int mode = sc.nextInt();

        if (mode == 2) {
            System.out.println("Enter the tolerance you would like to have for the group mode:");
        ...
        System.out.println("The file 'output.png' has been created.");
    }
